...
$crud->insertMovieInfo($_POST,$_FILES);
}
      ...
      <div class="content-wrapper">
       ...
       <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Add Movie Info</li>
          </ol>
        </section>
        <!-- Main content -->
                        ...
                        <div class="card">
                            <div class="card-body">
                            	...
                            	<div class="container-fluid">
                                  ...
                                  <div class="col-md-12">
                                  <div class="form-group has-feedback">
                          <input type="text" class="form-control" placeholder="Movie Info" name="info" required="required" />
                          </div>
                                  </div>
                          ...
                          <input type="text" class="form-control" placeholder="Charge" name="charge" required="required" />
                                  ...
                                  <div class="col-md-12">
                                  <div class="form-group has-feedback">
                          <input type="file" class="form-control" placeholder="Movie Image" name="img1" required="required" />
                          </div>
                                  </div>


                            			 <div class="col-md-4">
							             <button type="submit" name="submit" class="btn btn-primary btn-block btn-flat"><i class="fa fa-plus"></i>&nbsp;Add Movie Info</button>
							             </div>
