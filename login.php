...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="index.php"><span class="fa fa-youtube-play"></span>&nbsp;&nbsp;MOVIE TICKET RESERVATION SYSTEM</a>
...
<div class="container-fluid col-lg-4 offset-lg-8">
      ...
      <div class="card-body"><?php $lib->msg();?>
        ...
        <div class="text-center">
         <a class="d-block small mt-3" href="reg.php">Create an Account</a>
          <a class="d-block small mt-3" href="index.php"><i class="fa fa-home"></i>&nbsp;&nbsp;&nbsp;Back to Home</a>
        </div>
      </div>
    </div>
<br/>
